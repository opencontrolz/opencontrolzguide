      ...
      links: [
        {
          ...
          link: 'https://github.com/opencontrolz/opencontrolzguide/blob/main/docs/getting-started-guides/helloworld.md'
        },
        {
          icon: 'title',
          name: 'Tenant profiles',
          link: 'https://github.com/opencontrolz/opencontrolzguide/blob/main/docs/user-guide/tenant-profiles.md'
        },
        {
          icon: 'insert_chart',
          name: 'API',
          link: 'https://github.com/opencontrolz/opencontrolzguide/blob/main/docs/api.md'
        },
        {
          icon: 'now_widgets',
          name: 'Widgets Library',
          link: 'https://github.com/opencontrolz/opencontrolzguide/blob/main/docs/user-guide/ui/widget-library.md'
        }
      ]
    }],
    [Authority.TENANT_ADMIN, {
      links: [
        ...
        },
        {
          ...
          name: 'Rule engine',
          link: 'https://github.com/opencontrolz/opencontrolzguide/blob/main/docs/user-guide/rule-engine-2-0/re-getting-started.md'
        },
        {
          icon: 'insert_chart',
          name: 'API',
        ...
        },
        {
          ...
          link: 'https://github.com/opencontrolz/opencontrolzguide/blob/main/docs/user-guide/device-profiles.md'
        }
      ]
    }],
